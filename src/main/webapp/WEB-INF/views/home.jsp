		...
		<div class="box-container">
			...
			<div class="box">
				...
				<div class="content">
					...
					<p>kHÁM PHÁ HỘI AN KIẾN TRÚC CỔ XƯA VÀ ẨM THỰC ĐỘC ĐÁO MIỀN
						TRUNG</p>
					<div class="stars">
					...
					<div class="price">
						3.400.000 VNĐ - <span>5.500.000 VNĐ</span>
					</div>
			...
			<div class="box">
				...
				<div class="content">
					...
					<div class="price">
						4.500.000 VNĐ - <span>7.500.000 VNĐ</span>
					</div>
					<a href="#" class="btn">Đặt ngay</a>
				</div>
			</div>
			...
			<div class="box">
				...
				<div class="content">
					...
					<div class="price">
						3.000.000 VNĐ - <span>5.000.000 VNĐ</span>
					</div>
					<a href="#" class="btn">Đặt ngay</a>
				</div>
			</div>
			...
			<div class="box">
				...
				<div class="content">
					...
					<div class="price">
						3.800.000 VNĐ - <span>6.200.000 VNĐ</span>
					</div>
					<a href="#" class="btn">Đặt ngay</a>
				</div>
			</div>
			...
			<div class="box">
				...
				<div class="content">
					...
					<div class="price">
						2.800.000 VNĐ - <span>4.200.000 VNĐ</span>
					</div>
					<a href="#" class="btn">Đặt ngay</a>
				</div>
			</div>
			...
			<div class="box">
				...
				<div class="content">
					...
					<div class="price">
						5.800.000 VNĐ - <span>7.200.000 VNĐ</span>
					</div>
					<a href="#" class="btn">Đặt ngay</a>
				</div>
			</div>
		...
		<div class="box-container">
			...
			<div class="box">
				...
				<p>Amazing Việt Nam Thấu hiểu sự vất vả của bạn trong công việc
					nên được phục vụ trong những chuyến du lịch là sự vui mừng của
					chúng tối</p>
			</div>
			<div class="box">
		...
		<div class="box-container">
			...
			<div class="box">
				...
				<div class="content">
					...
					<p>Xã hội này hông làm đòi đi du lịch thì chỉ có đi trên
						Amazing Việt Nam thế cho nó dễ nhá</p>
			...
			<div class="box">
				...
				<div class="content">
					<h3>Thông Sói Ca</h3>
					<p>Nếu em thích lãng mạng hội Châu Âu thì em hãy đến với anh
						còn không hãy đến với Amazing Việt Nam</p>
			...
			<div class="box">
				...
				<div class="content">
					...
					<p>Đi thật xa để trở về về đâu thì đã có Amazing Việt Nam Lo
						cảm ơn vì tất cả</p>
			...
			<div class="box">
				...
				<div class="content">
					...
					<p>Nhặt được của rơi chắn chắn còn cái nịt nhưng đi du lịch
						chắc chắn được Amazing Việt Nam lo</p>
			...
			<div class="swiper-wrapper">
				...
				<div class="swiper-slide">
					<div class="box">
						...
						<p>Từ nhỏ tôi không biết du lịch nhưng từ khi được biết
							Amazing Việt Nam đã có những chuyến đi rất vui</p>
						<div class="stars">
							<i class="fas fa-star"></i> <i class="fas fa-star"></i> <i
								class="fas fa-star"></i> <i class="fas fa-star"></i> <i
								class="far fa-star"></i>
